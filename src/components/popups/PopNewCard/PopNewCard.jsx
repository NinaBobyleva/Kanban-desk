...
function PopNewCard() {
  ...
  const [value, setValue] = useState(
    <TitleDayPicker>Выберите срок исполнения.</TitleDayPicker>
  );
          ...
          <S.PopNewCardContent>
            ...
            <S.PopNewCardWrap>
              <S.PopNewCardForm id="formNewCard" action="#">
                <S.FormNewBlock>
                  <S.SubttlCard htmlFor="formTitle">
                    Название задачи
                  </S.SubttlCard>
                  <S.FormNewInput
                    onChange={onChangedInputTask}
                    type="text"
                    value={newInputTask.title}
                    name="title"
                    id="formTitle"
                ...
                <S.FormNewBlock>
                  <S.SubttlCard htmlFor="textArea">
                    Описание задачи
                  </S.SubttlCard>
                  <S.FormNewArea
                    onChange={onChangedInputTask}
                    value={newInputTask.description}
                    name="description"
                    id="textArea"
            ...
            {error && error}
            <S.FormNewCreate id="btnCreate" onClick={onAddNewCard}>
              Создать задачу
            </S.FormNewCreate>
          </S.PopNewCardContent>
        </S.PopNewCardBlock>
